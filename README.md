...
Recently, we deployed the image captioning system to mobile device, find [demo] (https://youtu.be/K9q-6_ogQEM) and [code](https://github.com/deepsemantic/Captioner).
